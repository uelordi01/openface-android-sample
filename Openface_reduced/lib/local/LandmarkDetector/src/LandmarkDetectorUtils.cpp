...
// true if file exists
bool fileExists3(const std::string& file) {
    struct stat buf;
...
//            std::string image_directory (arguments[i+1]);

//			try
//			{
//				 // does the file exist and is it a directory
//                if (fileExists3(image_directory) && is_directory(image_directory))
//				{
